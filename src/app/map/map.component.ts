...
/* Map Imports */
import { Deck, MapView, View, _GlobeView as GlobeView, COORDINATE_SYSTEM, PostProcessEffect } from '@deck.gl/core';
...
export class MapComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public mapLayerGlobe = new TileLayer({
    data: mapTiles.styles[defaultMapStyle].url,     //// Change here the default map style
    maxZoom: 14,
    tileSize: 256,
