  ...
  getGeojsonFromWKT(footprint: string) {
    ...
    */
    ...
    if (footprint) {
      ...
      if (footprint.search('-180.0') != -1) {
        //console.log("PRE:");
        //console.log(footprint);
        //console.log("String '-180.0' is present! \nChecking if it is a multipolygon..");
        let firstPoint = footprint.substring(footprint.search('POLYGON')+9, footprint.search(','));
        //console.log(firstPoint);
        let polygons = footprint.split(firstPoint);
        //console.log(polygons);
        let isMultipolygon = true;
        ...
        if (isMultipolygon) {
          footprint = polygons[0].replace("POLYGON", "MULTIPOLYGON") + "(" + firstPoint + polygons[1] + firstPoint + ")),((" + polygons[2].substring(1, polygons[2].length -1) + ")'";
          //console.log("POST:");
          //console.log(footprint);
        }
      }
